...
// ---------- 群聊中是否应该回复 ----------
let botUsername = "";
function shouldRespondInGroup(text, isReplyToBot) {
    if (isReplyToBot)
        return true;
...
// ---------- 构建消息历史 ----------
function buildMessages(chatId, maxMessages) {
...
bot.on("text", async (ctx) => {
    ...
    const isReplyToBot = "reply_to_message" in ctx.message &&
...
// ---------- 下载语音并转文字 ----------
async function transcribeVoice(buffer, duration) {
